...
import com.github.ilee2.hitstats.HistoryFilter;
import com.github.ilee2.hitstats.HistoryScope;
import com.github.ilee2.hitstats.HitRecord;
 ...
 * damage it produced.
 */
public class HitStatsPanel extends PluginPanel
{
	...
	public HitStatsPanel(HitStatsStore store, HitStatsConfig config,
	...
	private JPanel header()
	{
		...
		final JLabel title = new JLabel("Hit Stats");
	...
	private JPanel killingBlowRow()
	{
		...
		killingBlowBox.addActionListener(e ->
		{
			if (!populating)
			{
				configManager.setConfiguration(HitStatsConfig.GROUP, "includeKillingBlows",
	...
	private JPanel protectionRow()
	{
		...
		protectionBox.addActionListener(e ->
		{
			if (!populating)
			{
				configManager.setConfiguration(HitStatsConfig.GROUP, "countProtectedAttacks",
